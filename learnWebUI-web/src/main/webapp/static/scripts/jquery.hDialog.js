	...
	*/
	$.extend({  
	    ...
	    showLoading: function (t, w, h) { //显示加载
        	...
        	$body.stop().append('<div id="HLoading" class="loading-mode" style="width:'+w+'px;height:'+h+'px;line-height:'+h+'px;background:rgba(245,14,14,0.6);color:#fff;text-align:center;position:fixed;top:50%;left:50%;margin:'+margin+';">'+t+'</div>');
	    },
